...
class UrlValidationServiceTest {
  ...
  void isValidUrl_WhenAllConditionsValid_ReturnsTrue() {
    try (MockedStatic<UrlExpirationTimeService> expirationMock =
            mockStatic(UrlExpirationTimeService.class);
      ...
      expirationMock
          .when(() -> UrlExpirationTimeService.checkActiveUrlExpirationTime(urlInfo))
          .thenReturn(true);
