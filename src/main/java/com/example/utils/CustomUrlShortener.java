...
public class CustomUrlShortener {
    ...
    public static String shortenUrl(String originalUrl, UUID uuid) {
        try {
            ...
            // 2. Используем MD5 (32-символьный хэш, даже небольшие различия дают РАЗНЫЕ хэши)
	...
	public static String fallbackShortenUrl(String originalUrl, UUID uuid) {
        ...
        String shortCode = Base64.getUrlEncoder().withoutPadding().encodeToString(combined.getBytes())
				.substring(0, 8);
